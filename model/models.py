...
class Colaboradores(BaseModel):
    ...
    fk_departamentos_num_dep = peewee.ForeignKeyField(Departamentos, on_delete='CASCADE' ,related_name='departamento')
...
class Projetos(BaseModel):
    ...
    fk_departamentos_num_dep = peewee.ForeignKeyField(Departamentos, on_delete='CASCADE', related_name='Departamentos')
